...
The Olympus consensus mechanisms require specific data to be allocated on-chain to validate it during the initial blockchain download or the block and transactions broadcast process.  
...
6 | Pay | Special coin ownership transfer 
...
2 | Coins | Generate | `coin-generate` | Create coins
3 | Coins | Pay | `coin-pay` | Change the ownership of coins to a non-user.
...
`Pay`
 ...
 Name | Type | Usage 
---|---|---
 Type | PaymentType | The payment type specified 
 TxIn | []Inputs | Inputs for the payment. Signing depends on the PaymentType.
 TxOut | []Outputs | Outputs to assign the coins to.
 
Implementations:
* [Ogen](https://github.com/grupokindynos/ogen/blob/develop/txs/txpayloads/coins/coins.go)
...
Implementations:
* [Ogen](https://github.com/grupokindynos/ogen/blob/develop/txs/txpayloads/workers/workers.go)
...
Implementations:
* [Ogen](https://github.com/grupokindynos/ogen/blob/develop/txs/txpayloads/gov/gov.go)
...
Implementations:
* [Ogen](https://github.com/grupokindynos/ogen/blob/develop/txs/txpayloads/votes/votes.go)
...
Implementations:
* [Ogen](https://github.com/grupokindynos/ogen/blob/develop/txs/txpayloads/users/users.go)
